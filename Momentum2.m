...
%estimate expected return stand,standard deviation and sharpe
MomExpRet=mean(momentum)
MomStDev=std(momentum)
MomSharpe=MomExpRet/MomStDev 

StrExpRet=mean(STR)
StrStDev=std(STR)
StrSharpe=StrExpRet/StrStDev
momentum=PorReturn;
